...
function VerticalNavigation () {
    ...
    return (
        <div className="sportsee-vertical-navbar">
            <nav>
                <ul>
                    <li><img className="sportsee-icon" src={icon_sport_1} alt=""/></li>
                    <li><img className="sportsee-icon" src={icon_sport_2} alt=""/></li>
                    <li><img className="sportsee-icon" src={icon_sport_3} alt=""/></li>
                    <li><img className="sportsee-icon" src={icon_sport_4} alt=""/></li>
                </ul>
            </nav>
